    ...
    inner class DetailViewRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
            ...
            viewholder.findViewById<TextView>(R.id.detailviewitem_favoritecounter_textview).text =
                "Likes " + contentDTOs!![p1].favoriteCount + "개"
            ...
            FirebaseFirestore.getInstance().collection("profileImages")
                ...
                if (task.isSuccessful) {
                    ...
                    Glide.with(viewholder.context).load(url).apply(RequestOptions().circleCrop())
        ...
        fun favoriteAlarm2(destinationUid: String) {
            ...
            var message =
                FirebaseAuth.getInstance()?.currentUser?.email + getString(R.string.alarm_poke)
            FcmPush.instance.sendMessage(destinationUid, "Pleme", message)
        }
